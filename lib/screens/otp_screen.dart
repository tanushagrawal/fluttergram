...
class CheckOtp extends StatefulWidget {
  ...
  CheckOtp(
      {@required String otp,  String phonenumber, String pa,@required String use}) {
    otp = otp;
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 20),
                Text("time left : ${120 - seconds.toInt()} secs",
                    style: GoogleFonts.poppins(
                      fontSize: 15,
                      fontWeight: FontWeight.w600,
                      color: Colors.white,
                    ...
                    if (entered_otp == otp) {
                      if (otpUse=="registration") {
                        ...
                        Navigator.push(context, MaterialPageRoute(
                            builder: (context) =>
                                CreateUserProfile(phone: mobileNumber, password: p)));
                      }
                      if(otpUse=="resetpass"){
                        print("ok resetting");
                      }
